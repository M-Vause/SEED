...
function [vals,vars] = EX01a_Linear2D(varargin)
...
function [vals,vars] = run()
    ...
    vars = poolDataLIST({'x','y'},Xi,n,polyorder,usesine);
...
function [variables,values] = get_params()
    variables = {'Polyorder', 'Number of Dimensions', 'Dynamics', 'Timespan', 'Initial Conditions'};
    values = {5, 2, '-.1 2; -2 -.1', '0.0; 25.0', '2; 0'};
end