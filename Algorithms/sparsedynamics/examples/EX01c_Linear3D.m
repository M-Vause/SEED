...
function [vals,vars] = EX01c_Linear3D(varargin)
...
function [variables,values] = get_params()
    variables = {'polyorder','Number of Dimensions','Dynamics','dt','Timespan','Initial Conditions'};
    values = {2,3,'-.1 2 0; -2 -.1 0 ; 0 0 -.3',0.01,'0; 50','2; 0; 1'};
end
