...
function [vals,vars] = EX03_Cylinder(varargin)
...
function [vals,vars] = run()
    ...
    %addpath('./data');
    addpath('Algorithms/sparsedynamics/examples/data');
    ...
    a = load('PODcoefficients_run1.mat');
    alpha = a.alpha;
    alphaS = a.alphaS;
