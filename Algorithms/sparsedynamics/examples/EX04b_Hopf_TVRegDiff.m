...
function [vals,vars] = EX04b_Hopf_TVRegDiff(varargin)
...
function [vals,vars] = run()
    ...
    vars = poolDataLIST({'x','y','u'},Xi,3,polyorder,usesine);
...
function [variables,values] = get_params()
    variables = {'polyorder','epsilon','lambda','mu','omega','dt','Timespan'};
    values = {5,0.005,0.25,0.1,1,0.0025,'0.0025; 75'};
end