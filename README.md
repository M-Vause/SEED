...
### Prerequisite
In order to run SEED, Python 3.6 or 3.7 must be installed on your computer. If it isn't, it can be downloaded and installed from [the Python website](https://www.python.org/downloads/release/python-377/). If you are a windows user, ensure you check the box stating _XXXX_ during installation.
...
To understand how to interpret the output fully, consult the algorithm's documentation.
...
## Expansion
As mentioned in the introduction, you can add your own algorithms to SEED if you wish. There are XXXX things that are important when editing your algorithm to add to SEED, these are:
